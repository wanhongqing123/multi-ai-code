...
class MaiHttpServer {
public:
    MaiHttpServer(MaiAgent& agent, MaiHttpServerOptions opts);
    ~MaiHttpServer();
    MaiHttpServer(const MaiHttpServer&) = delete;
    MaiHttpServer& operator=(const MaiHttpServer&) = delete;
