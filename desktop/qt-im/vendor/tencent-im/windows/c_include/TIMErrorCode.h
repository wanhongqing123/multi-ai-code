...
enum TIMErrCode {
    ...
    ERR_SVR_COMM_PRE_HOOK_FAILED                = 80003,  // 发单聊消息前回调或发群聊消息前回调失败或回包超时，消息不下发。可在控制台自助配置 事件发生之前回调超时的处理策略。
    ERR_SVR_COMM_SENSITIVE_IMAGE                = 80004,  // 图片安全打击，图片中可能包含敏感内容。
    ERR_SVR_COMM_SERVICE_DISABLED               = 80005,  // 服务已停用，如版本到期请购买或续费套餐包，如账号欠费请充值。
