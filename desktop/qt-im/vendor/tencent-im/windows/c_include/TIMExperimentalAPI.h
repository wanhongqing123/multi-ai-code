...
static const char* kTIMInternalOperationConvertTextToVoice = "internal_operation_convert_text_to_voice";
static const char* kTIMInternalOperationVoiceClone = "internal_operation_voice_clone";
static const char* kTIMInternalOperationGetCustomVoiceList = "internal_operation_get_custom_voice_list";
...
// int, @ref ServerAddress, 只写, 服务器类型
static const char* kTIMCustomServerInfoServerType = "server_type";
...
//------------------------------------------------------------------------------
// 4.13 ReportRoomEngineEvent(RoomEngine 事件上报的参数)
// uint32, 只写(必填)
...
// 4.14 ReportTUIFeatureUsage(Atomicx 上报)
...
//------------------------------------------------------------------------------
// 4.15 CustomUploadCallbackParam(设置自定义上传回调的参数)
// 当 kTIMRequestInternalOperation 为 kTIMInternalOperationSetCustomUploadCallback 时需要设置
// uint64, 只写(必填), 自定义上传回调函数地址，类型为 TIMCustomUploadCallback
static const char* kTIMCustomUploadCallbackParamUploadCallback = "custom_upload_callback_param_upload_callback";
// uint64, 只写(必填), 自定义上传取消回调函数地址，类型为 TIMCustomUploadCancelCallback
static const char* kTIMCustomUploadCallbackParamCancelCallback = "custom_upload_callback_param_cancel_callback";

//------------------------------------------------------------------------------
// 4.16 RequestParam(callExperimentalAPI 接口请求的参数)
...
// string, 只写(必填), 需要转语音的文字内容, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationConvertTextToVoice 时需要设置
static const char* kTIMRequestConvertTextToVoiceText = "request_convert_text_to_voice_text";
// string, 只写(选填), TTS 音色 ID, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationConvertTextToVoice 时需要设置
static const char* kTIMRequestConvertTextToVoiceVoiceId = "request_convert_text_to_voice_voice_id";
// string, 只写(选填), 音频格式: pcm wav, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationConvertTextToVoice 时需要设置
static const char* kTIMRequestConvertTextToVoiceAudioFormat = "request_convert_text_to_voice_audio_format";
// string, 只写(选填), 语言代码 (参考ISO 639-1), 当 kTIMRequestInternalOperation 为 kTIMInternalOperationConvertTextToVoice 时需要设置
static const char* kTIMRequestConvertTextToVoiceLanguage = "request_convert_text_to_voice_language";
// string, 只写(必填), 声音克隆的名称, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationVoiceClone 时需要设置
static const char* kTIMRequestVoiceCloneVoiceName = "request_voice_clone_voice_name";
// string, 只写(必填), 声音克隆的参考音频URL (16k单声道wav, 10-18秒), 当 kTIMRequestInternalOperation 为 kTIMInternalOperationVoiceClone 时需要设置
static const char* kTIMRequestVoiceCloneAudioUrl = "request_voice_clone_audio_url";
// string, 只写(选填), 声音克隆的参考文本, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationVoiceClone 时需要设置
static const char* kTIMRequestVoiceClonePromptText = "request_voice_clone_prompt_text";
// string, 只写(选填), 语言代码 (参考ISO 639-1), 当 kTIMRequestInternalOperation 为 kTIMInternalOperationVoiceClone 时需要设置
static const char* kTIMRequestVoiceCloneLanguage = "request_voice_clone_language";
// string, 只写(必填), 要删除的音色 ID, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationDeleteCustomVoice 时需要设置
...
// string, 只读(选填), 音频文件下载地址, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationConvertTextToVoice 时有值
static const char* kTIMResponseConvertTextToVoiceAudioUrl = "response_convert_text_to_voice_audio_url";
// string, 只读(选填), 唯一请求 ID, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationConvertTextToVoice 时有值
static const char* kTIMResponseConvertTextToVoiceRequestId = "response_convert_text_to_voice_request_id";
// string, 只读(选填), 克隆的音色 ID, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationVoiceClone 时有值
static const char* kTIMResponseVoiceCloneVoiceId = "response_voice_clone_voice_id";
// string, 只读(选填), 唯一请求 ID, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationVoiceClone 时有值
static const char* kTIMResponseVoiceCloneRequestId = "response_voice_clone_request_id";
// array, 只读(选填), 自定义音色列表, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationGetCustomVoiceList 时有值
static const char* kTIMResponseGetCustomVoiceListVoiceList = "response_get_custom_voice_list_voice_list";
// string, 只读(必填), 克隆出的音色ID,可以用此id进行语音合成
