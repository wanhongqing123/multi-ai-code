...
public:
     ...
     */
    virtual void SearchCloudGroups(const V2TIMGroupSearchParam& searchParam,
                                   V2TIMValueCallback<V2TIMGroupSearchResult>* callback) = 0;
    ...
    /**
     * 2.6 设置群属性。已有该群属性则更新其 value 值，没有该群属性则添加该属性。
     * @note
     *   - 6.7 及其以前版本，只支持 AVChatRoom 直播群；
     *   - 从 6.8 版本开始，同时支持 AVChatRoom、Public、Meeting、Work 四种群类型；
     *   - 从 7.0 版本开始，除了话题外，群属性支持所有的群类型。
    ...
    /**
     * 2.7 删除指定群属性，keys 传大小为 0 的 V2TIMStringVector 则清空所有群属性。
     * @note
     *   - 6.7 及其以前版本，只支持 AVChatRoom 直播群；
     *   - 从 6.8 版本开始，同时支持 AVChatRoom、Public、Meeting、Work 四种群类型；
     *   - 从 7.0 版本开始，除了话题外，群属性支持所有的群类型。
    ...
    /**
     * 2.8 获取指定群属性，keys 传 keys 传大小为 0 的 V2TIMStringVector 则获取所有群属性。
     * @note
     *   - 6.7 及其以前版本，只支持 AVChatRoom 直播群；
     *   - 从 6.8 版本开始，同时支持 AVChatRoom、Public、Meeting、Work 四种群类型；
     *   - 从 7.0 版本开始，除了话题外，群属性支持所有的群类型。
     ...
     *
     *  - 直播群（AVChatRoom）的限制：
     *  1. 设置 filter 为 V2TIM_GROUP_MEMBER_FILTER_ADMIN，SDK 会返回所有管理员；设置 filter 为 SDK 定义的其他值，SDK 返回全部成员。
     ...
     *  4. 群成员资料信息仅支持 userID | nickName | faceURL 字段。
     *
     *  - 社群（Community）的限制：
     ...
     * - 该功能为 IM 增值功能，详见[价格说明](https://cloud.tencent.com/document/product/269/11673?from=17176#.E5.9F.BA.E7.A1.80.E6.9C.8D.E5.8A.A1.E8.AF.A6.E6.83.85)
     */
    virtual void SearchCloudGroupMembers(
        const V2TIMGroupMemberSearchParam& param,
        V2TIMValueCallback<V2TIMGroupMemberSearchResult>* callback) = 0;
