...
import { rootDir, setActiveAccount } from '../../../electron/store/paths.js'
import {
...
beforeEach(async () => {
  ...
  setActiveAccount('screenshot-settings-test')
  clearScreenshotHotkeySettingsCache()
})
...
describe('mergeScreenshotHotkeySettings', () => {
  it('keeps the screenshot hotkey disabled when enabled is not configured', () => {
